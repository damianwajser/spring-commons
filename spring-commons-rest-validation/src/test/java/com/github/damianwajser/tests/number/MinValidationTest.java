...
import com.github.damianwajser.model.number.min.MinNumberObject;
...
public class MinValidationTest {
	...
	public void min_number() throws Exception {
		...
		assertThat(validationFor(new MinNumberObject(3l)), succedes());
	...
	public void min_number_obect() throws Exception {
		...
		assertThat(validationFor(new MinPrimitiveObject(2)), succedes());
